...
# Asiakas-luokka, joka peruu henkilö-luokan ominaisuudet ja jolla on erillinen asiakasnumero-ominaisuus
...
# Nauratetaan asiakasta, joka perii nauru()-metodin Henkilö-luokalta
asiakas.nauru()
